---
name: debugging
description: Debug Android defects using logs, stack traces, lifecycle analysis, threading, memory, network inspection, reproduction steps, and root-cause isolation.
---
