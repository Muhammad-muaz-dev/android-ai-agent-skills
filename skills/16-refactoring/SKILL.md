---
name: refactoring
description: Refactor Android code safely while preserving behavior, reducing duplication, improving architecture boundaries, readability, testability, and maintainability.
---
